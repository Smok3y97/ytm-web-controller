...
const RAW_PATHS: Record<string, string> = {
  ...
  play: '<path d="M8 5v14l11-7z" fill="#FFFFFF"/>',
  ...
  volumeup: '<path d="M3 9v6h4l5 5V4L7 9H3zm11 3h6m-3-3v6" fill="#FFFFFF" stroke="#FFFFFF" stroke-width="2" stroke-linecap="round"/>',
  volumedown: '<path d="M3 9v6h4l5 5V4L7 9H3zm11 3h6" fill="#FFFFFF" stroke="#FFFFFF" stroke-width="2" stroke-linecap="round"/>',
