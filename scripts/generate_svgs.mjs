/**
 * Stream Deck & Browser Extension SVG Icon Generator
 */
import fs from "fs";
...
const icons = {
  ...
  <path d="M6.5 12V10.8C6.5 7.7 9 5.2 12 5.2C15 5.2 17.5 7.7 17.5 10.8V12" stroke="#FFFFFF" stroke-width="1.8" stroke-linecap="round" fill="none"/>
  <rect x="5.2" y="11.2" width="2.6" height="5.6" rx="1.3" fill="#FFFFFF"/>
  <rect x="16.2" y="11.2" width="2.6" height="5.6" rx="1.3" fill="#FFFFFF"/>
  <polygon points="10.8,9.8 15.2,12.2 10.8,14.6" fill="#FFFFFF"/>
</svg>`,

	// Category Icon (White monochrome for sidebar / action list - Headset with embedded play symbol)
	"category-icon": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="28" height="28" fill="none">
  <path d="M4.5 12V11C4.5 6.86 7.86 3.5 12 3.5C16.14 3.5 19.5 6.86 19.5 11V12" stroke="#FFFFFF" stroke-width="2.2" stroke-linecap="round" fill="none"/>
  <rect x="3" y="11.5" width="3.2" height="7" rx="1.6" fill="#FFFFFF"/>
  <rect x="17.8" y="11.5" width="3.2" height="7" rx="1.6" fill="#FFFFFF"/>
  <polygon points="10.5,10.2 15.5,13 10.5,15.8" fill="#FFFFFF"/>
</svg>`,
  ...
  <path d="M7 7h10v3l4-4-4-4v3H5v6h2V7zm10 10H7v-3l-4 4 4 4v-3h12v-6h-2v4zm-4-2V9h-1l-2 1v1h1.5v4H13z"/>
	...
	// Volume Up / Down / Mute
	"actions/volumeup/icon": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="144" height="144" fill="#FFFFFF">
  <path d="M3 9v6h4l5 5V4L7 9H3zm13.5 3c0-1.77-1.02-3.29-2.5-4.03v8.05c1.48-.73 2.5-2.25 2.5-4.02zM14 3.23v2.06c2.89.86 5 3.54 5 6.71s-2.11 5.85-5 6.71v2.06c4.01-.91 7-4.49 7-8.77s-2.99-7.86-7-8.77z"/>
</svg>`,

	"actions/volumedown/icon": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="144" height="144" fill="#FFFFFF">
  <path d="M18.5 12c0-1.77-1.02-3.29-2.5-4.03v8.05c1.48-.73 2.5-2.25 2.5-4.02zM5 9v6h4l5 5V4L9 9H5z"/>
</svg>`,

	"actions/mute/icon": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="144" height="144" fill="#FFFFFF">
  <path d="M16.5 12c0-1.77-1.02-3.29-2.5-4.03v2.21l2.45 2.45c.03-.2.05-.41.05-.63zm2.5 0c0 .94-.2 1.82-.54 2.64l1.51 1.51C20.63 14.91 21 13.5 21 12c0-4.28-2.99-7.86-7-8.77v2.06c2.89.86 5 3.54 5 6.71zM4.27 3L3 4.27 7.73 9H3v6h4l5 5v-6.73l4.25 4.25c-.67.52-1.42.93-2.25 1.18v2.06c1.38-.31 2.63-.95 3.69-1.81L19.73 21 21 19.73l-9-9L4.27 3zM12 4L9.91 6.09 12 8.18V4z"/>
</svg>`,

	"actions/mute/unmuted": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="144" height="144" fill="#FFFFFF">
  <path d="M3 9v6h4l5 5V4L7 9H3zm13.5 3c0-1.77-1.02-3.29-2.5-4.03v8.05c1.48-.73 2.5-2.25 2.5-4.02zM14 3.23v2.06c2.89.86 5 3.54 5 6.71s-2.11 5.85-5 6.71v2.06c4.01-.91 7-4.49 7-8.77s-2.99-7.86-7-8.77z"/>
</svg>`,

	"actions/mute/muted": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="144" height="144" fill="#FF0033">
  <path d="M16.5 12c0-1.77-1.02-3.29-2.5-4.03v2.21l2.45 2.45c.03-.2.05-.41.05-.63zm2.5 0c0 .94-.2 1.82-.54 2.64l1.51 1.51C20.63 14.91 21 13.5 21 12c0-4.28-2.99-7.86-7-8.77v2.06c2.89.86 5 3.54 5 6.71zM4.27 3L3 4.27 7.73 9H3v6h4l5 5v-6.73l4.25 4.25c-.67.52-1.42.93-2.25 1.18v2.06c1.38-.31 2.63-.95 3.69-1.81L19.73 21 21 19.73l-9-9L4.27 3zM12 4L9.91 6.09 12 8.18V4z"/>
</svg>`,

	// Volume Dial
	"actions/volumedial/icon": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="144" height="144">
  <circle cx="12" cy="12" r="10" fill="none" stroke="#FFFFFF" stroke-width="2" stroke-dasharray="45 10"/>
  <path d="M7 9v6h3l4 4V5l-4 4H7zm7.5 3c0-1.77-1.02-3.29-2.5-4.03v8.05c1.48-.73 2.5-2.25 2.5-4.02z" fill="#FFFFFF"/>
</svg>`,
  ...
  <path d="M7 8.5v7l4.5-3.5zm5 0v7l4.5-3.5z" fill="#FFFFFF"/>
	...
	// Seek Forward (Circular Fast Forward +10s)
	"actions/seekforward/icon": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="144" height="144" fill="#FFFFFF">
  <path d="M18 13c0 3.31-2.69 6-6 6s-6-2.69-6-6 2.69-6 6-6v4l5-5-5-5v4c-4.42 0-8 3.58-8 8s3.58 8 8 8 8-3.58 8-8h-2z"/>
  <path d="M10.86 15.94H9.72V11.2h-.03l-1.39.95-.44-.8 2-1.35h.99v6zM14.65 10.96c.38.3.57.8.57 1.48v1.65c0 .68-.19 1.18-.57 1.48-.38.3-.92.45-1.61.45s-1.23-.15-1.61-.45c-.38-.3-.57-.8-.57-1.48v-1.65c0-.68.19-1.18.57-1.48.38-.3.92-.45 1.61-.45s1.23.15 1.61.45zm-.82 3.23v-1.85c0-.3-.06-.52-.18-.65-.12-.13-.3-.2-.55-.2s-.43.07-.55.2c-.12.13-.18.35-.18.65v1.85c0 .3.06.52.18.65.12.13.3.2.55.2s.43-.07.55-.2c.12-.13.18-.35.18-.65z"/>
</svg>`,

	// Seek Backward (Circular Rewind -10s)
	"actions/seekbackward/icon": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="144" height="144" fill="#FFFFFF">
...
console.log("Successfully wrote all SVG vector assets!");