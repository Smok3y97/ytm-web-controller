...
export class VersionControlService {
  ...
  public readonly currentPluginVersion: string = (manifest && manifest.Version) ? manifest.Version : '1.5.0.0';
  public readonly minRequiredExtensionVersion: string = (manifest && manifest.Version) ? manifest.Version : '1.5.0.0';
  ...
  public validateHandshake(extVersion: string): {
    ...
    return {
      ...
      payload: isCompatible
        ? this.getHandshakeAckPayload()
        : this.getVersionMismatchPayload(extVersion)
    };
  }
}
